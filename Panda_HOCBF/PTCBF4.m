...
if (id > -1)
    ...
    p0 = [0.4; 0.0; 0.3]; 
    newPos = [0.4, 0.0, 0.3];
    vrep.simxSetObjectPosition(id, safe_region_handles, -1, newPos, vrep.simx_opmode_oneshot);
    ...
    while vrep.simxGetConnectionId(id) ~= -1
        ...
        if CBF_switch
            ...
            D1 = -2*pdot1.'*pdot1 + alpha1*phi_dot_val*h1(i) ...
                 + (alpha1+alpha2)*phi_val*h1_dot ...
                 + alpha1*alpha2*phi_val*h1(i);
